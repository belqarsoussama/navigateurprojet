...
class SignUp:
    def __init__(self, root):
        ...
        frame = Frame(self.window, bg="burlywood2")
        ...
        f_name = Label(frame, text="First name", font=("helvetica",15,"bold"),bg="burlywood2").place(x=20, y=100)
        l_name = Label(frame, text="Last name", font=("helvetica",15,"bold"),bg="burlywood2").place(x=240, y=100)
        ...
        password =  Label(frame, text="New password", font=("helvetica",15,"bold"),bg="burlywood2").place(x=20, y=340)

        self.password_txt = Entry(frame,font=("arial"))
        self.password_txt.place(x=20, y=370, width=420)

        self.terms = IntVar()
        terms_and_con = Checkbutton(frame,text="I Agree The Terms & Conditions",variable=self.terms,onvalue=1,offvalue=0,bg="burlywood2",font=("times new roman",12)).place(x=20,y=420)
        self.signup = Button(frame,text="Sign Up",command=self.signup_func,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="burlywood3",fg="black").place(x=120,y=470,width=250)
        self.back_to_login_button = Button(frame, text="Back to Login Page", command=self.back_to_login,font=("times new roman", 14, "bold"), bd=0, cursor="hand2", bg="burlywood3",fg="black").place(x=120, y=520, width=250)
